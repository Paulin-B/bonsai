...
w.dark_box.setChecked(False); settle()
check("light theme applied", ga.THEMES["light"]["bg"] in w.styleSheet(), True)
w.dark_box.setChecked(True); settle()
check("dark theme applied", ga.THEMES["dark"]["bg"] in w.styleSheet(), True)
